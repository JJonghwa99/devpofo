...
* **추천 서버** : Python, Flask, NumPy, Pandas, Scikit-learn, SQLAlchemy, Psycopg2
...
* 팀 프로젝트 종료 이후 개인적으로 `scikit-learn`을 활용하여 코사인 유사도 기반으로 사용자 간의 유사도를 분석하고, 가장 유사한 사용자들의 수강 데이터를 바탕으로 강의를 추천하는 로직으로 변경.
